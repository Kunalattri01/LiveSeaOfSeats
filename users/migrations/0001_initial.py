    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_picture', models.ImageField(blank=True, db_column='PROFILE_PICTURE', null=True, upload_to='users/profile/')),
                ...
                ('role', models.CharField(choices=[('USER', 'USER'), ('ORGANIZER', 'ORGANIZER'), ('ADMIN', 'ADMIN')], db_column='ROLE', default='USER', max_length=20)),
