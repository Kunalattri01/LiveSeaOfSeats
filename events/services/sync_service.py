...
from events.models import Category, Organizer, Venue, Event, EventTag, Language
...
def sync_events():
    ...
    categories_dict, organizers_dict, venues_dict, cities_dict = {}, {}, {}, {}
